...
export default {
    ...
    methods: {
            ...
            for (let task of this.taskAllList) {
                if (
                    ...
                    (this.filter.type !== undefined &&
                        this.filter.type !== task.type) ||
                    (this.filter.status !== undefined &&
                        this.filter.status !== task.status) ||
                    (this.filter.atm !== undefined &&
                        this.filter.atm !== task.atm) ||
                    (this.filter.problem !== undefined &&
                        this.filter.problem !== task.problem)
                ) {
                    continue;
                } else {
        ...
        onRowExpand(event) {
            var history = this.taskAllList.filter(
