        ...
        >
            <section class="flex-row">
                ...
                <Select
                    ...
                    :placeholder="atmNeighborhood"
                    size="small"
                    class="last-field-relation"
                    style="width: 30%"
                >
                    <template #value="slotProps">
                        <div v-if="slotProps.value">
            ...
            <section class="flex-column">
                <div class="radio-buttom-align">
                    ...
                    >
                        ...
                        />
                        <label :for="'' + type.id" style="margin-right: 5%">{{
                            type.task_type
                        }}</label>
                    </div>
                </div>
                <div class="radio-buttom-align">
                    <div
                        v-for="status in generalStatus"
                        :key="status.id"
                        class="radio-buttom-self"
                    >
                        <RadioButton
                            v-model="selectGeneralStatus"
                            :inputId="'' + status.id"
                            name="dynamic"
                            :value="status.name"
                        />
                        <label :for="'' + status.id" style="margin-right: 5%">{{
                            status.name
                        }}</label>
                    </div>
                </div>
